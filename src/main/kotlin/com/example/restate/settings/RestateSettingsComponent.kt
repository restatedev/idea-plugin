...
class RestateSettingsComponent {
    private val downloadRestateServerCheckBox = JBCheckBox("Download Restate server (if unchecked, use system installed version)")
    ...
    private val mainPanel: JPanel = FormBuilder.createFormBuilder()
        ...
        .addSeparator()
        .addLabeledComponent(JBLabel("Environment Variables (format: KEY1=VALUE1;KEY2=VALUE2):"), environmentVariablesField, 1, false)
